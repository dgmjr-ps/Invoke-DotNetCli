@{
    RootModule    = "Invoke-DotNetCli.dll"
    ModuleVersion = '0.0.1'
    GUID          = 'ba8ae836-1d67-4271-a3ae-12c78c2cb941'
    Author        = 'David G. Moore, Jr.'
    CompanyName   = 'Dgmjr'
    Copyright     = '© 2023 David G. Moore, Jr. <david@dgmjr.io>, All Rights Reserved'
    Description   = 'A PowerShell module to invoke dotnet cli commands'
    ...
    PrivateData   = @{
        PSData = @{
            ...
            Tags                       = @('PowerShell', 'DotNet', 'CLI', 'Invoke', 'Build')
